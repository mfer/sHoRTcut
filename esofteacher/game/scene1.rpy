...
label scene1:
    ...
    S "{cps=40}Olá, então você eh o novo contratado?{/cps}"
    menu:
        ...
        "Não":
            S "{cps=40}Então o q você estah fazendo aqui?{/cps}" #Sprite mau =X
    ...
    menu:
        "Sim":
            S "{cps=40}Estou gostando de ver. Vejo que vem da {b}UFMG{/b}. Por um acaso você estudou com o Professor Rodolfo?{/cps}"
        "Não":
    ...
    menu:
        ...
        "Tradicional":
            S "{cps=40}Hmm, ok.{/cps}"
            S "{cps=40}Entao, você eh um lerdo.{/cps}"
            ...
            S "{cps=40}Então não se preocupe com as mudanças de requisitos.{w=2} Dediquem-se para fazer um bom levantamento de requisitos.{/cps}"
